...
| `monolith.image.repository`    | Monolith image repository                       | `ghcr.io/levikaw/software-architect-sprint-2/monolith` |
...
| `proxyService.image.repository`| Proxy service image repository                  | `ghcr.io/levikaw/software-architect-sprint-2/proxy-service` |
...
| `moviesService.image.repository`| Movies service image repository                | `ghcr.io/levikaw/software-architect-sprint-2/movies-service` |
...
| `eventsService.image.repository`| Events service image repository                | `ghcr.io/levikaw/software-architect-sprint-2/events-service` |
